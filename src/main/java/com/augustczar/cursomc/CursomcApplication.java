...
import com.augustczar.cursomc.domain.Estado;
import com.augustczar.cursomc.domain.ItemPedido;
import com.augustczar.cursomc.domain.Pagamento;
import com.augustczar.cursomc.domain.PagamentoComBoleto;
import com.augustczar.cursomc.domain.PagamentoComCartao;
...
import com.augustczar.cursomc.repositories.CidadeRepository;
...
import com.augustczar.cursomc.repositories.EstadoRepository;
...
public class CursomcApplication  implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat3 = new Categoria(null, "Cama mesa e banhso");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmil.com", "36378912377", TipoCliente.PESSOA_FISICA);
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matus", "105", "Sala 800", "Centro", "30777012", cli1, c2);
